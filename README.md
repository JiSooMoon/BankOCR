...
This project has included User Story 1 to 3 in all different steps from this [CODING DOJO](https://codingdojo.org/kata/BankOCR/).
In order to make a clarification on each of step, created those into different public class and
added javadocs to increase readability.

Within `test_cases` folder, it includes all possible test cases to test. Have verified all coverage
as well as verified all cases by creating each of test cases.
